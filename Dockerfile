...
RUN wget /home/vcall_biodata/gatk/https://github.com/broadinstitute/gatk/releases/download/4.1.7.0/gatk-4.1.7.0.zip
RUN unzip /home/vcall_biodata/gatk/https://github.com/broadinstitute/gatk/releases/download/4.1.7.0/gatk-4.1.7.0.zip
RUN mv gatk-4.1.7.0 gatk

RUN mkdir /home/vcall_biodata/genome /home/vcall_biodata/samples /home/vcall_biodata/output
